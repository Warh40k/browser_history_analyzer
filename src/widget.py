...
# Taking history from db and output to table widget
    ...
    def most_visits_time(self):
        ...
        self.ui.sc = MplCanvas(self, width=5, height=4, dpi=100)
        print(self.dates_hour)
        self.ui.sc.axes.plot([i for i in range(24)], visits_per_hour)
        self.ui.sc.axes.set_ylabel("Число посещений")
        self.ui.sc.axes.set_xlabel("Время суток, час")
        self.ui.sc.axes.set_title("Активность сёрфинга")
        self.ui.formLayout_2.addWidget(self.ui.sc)
        print(type(self.ui.sc))
